      ...
      while (client.available()) {
        ...
        if (c == '\n') {
          ...
          if (request.indexOf("GET /status") != -1) {
            ...
            Serial.print(i);
            Serial.print(": ");
            Serial.println(digitalRead(relePins[i]));
            if (i < 9) client.print(",");
          }
          client.println("]}");
          Serial.println("\n");
          client.stop();
          return; // Garante que ele não continue e acabe mandando o HTML inteiro como dados
          ...
          client.println("<script>");
              // Função responsável por enviar o comando para determinado relé
          ...
          client.println("}");
              ...
              // Função responsável por atualizar a exibição do status ao lado de cada botão
